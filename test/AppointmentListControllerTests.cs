...
public class AppointmentlistControllertest
{
    ...
    [Fact]
    public void Get_WhenCalled_statuscodeshouldbe200()
    {
        var v1 = new AppointmentlistController();
    ...
    //FOR ADD
    [Fact]
    public void Add_InvalidObjectPassed_ReturnsBadRequestget409()
    {
    ...
    public void Add_InvalidObjectPassed_ReturnsBadRequest()
    {
        ...
        var v1 = new AppointmentlistController();
        var result = v1.Addapp(nameMissingItem) as OkObjectResult;
